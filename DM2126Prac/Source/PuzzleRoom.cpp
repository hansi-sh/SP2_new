...
void PuzzleRoom::rendertag()
{
	...
	RenderTextOnScreen(meshList[GEO_TEXT], std::to_string(itemcount) + "/" + std::to_string(totalitem), Color(0, 1, 0), 2, 45, 18);
	DrawHUD(meshList[GEO_Centre], Color(1, 1, 1), false, 2, 20, 9);
	for (int i = 0; i < 34; i++)
	{
		if (current->data == i)
		{
